...
class TestWalledAI:
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(WalledAIError):
            with update_env(**{"WALLEDAI_API_KEY": Omit()}):
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/guardrail").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/guardrail").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/guardrail").mock(side_effect=retry_handler)

        response = client.moderation.with_raw_response.create(text="text")
    ...
    def test_omit_retry_count_header(
        self, client: WalledAI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncWalledAI:
    ...
    async def test_retries_taken(
        ...
        response = await client.moderation.with_raw_response.create(text="text")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncWalledAI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.moderation.with_raw_response.create(
            text="text", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from walledai._utils import asyncify
        from walledai._base_client import get_platform 
